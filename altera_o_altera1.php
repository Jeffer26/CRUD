...
/**coleta as informações digitadas no formulário altera.php */
...
titulo_livro=:titulo_livro,cod_isbn=:cod_isbn,autor_livro=:autor_livro,
nome_editora=:nome_editora,qtd_paginas=:qtd_paginas 
